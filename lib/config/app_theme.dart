  ...
  static ThemeData get darkTheme {
    ...
    return ThemeData(
      ...
      textTheme: GoogleFonts.notoSansJpTextTheme(ThemeData.dark().textTheme).copyWith(
        ...
        bodyMedium: GoogleFonts.notoSansJp(fontSize: 15, color: Colors.white),
        bodySmall: GoogleFonts.notoSansJp(fontSize: 14, color: Colors.white70),
        titleLarge: GoogleFonts.notoSansJp(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white),
        titleMedium: GoogleFonts.notoSansJp(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.white),
        labelLarge: GoogleFonts.notoSansJp(fontSize: 16, fontWeight: FontWeight.w600),
      ),
      appBarTheme: AppBarTheme(
        centerTitle: true,
        elevation: 0,
        ...
        foregroundColor: Colors.white,
        titleTextStyle: GoogleFonts.notoSansJp(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.white),
      ),
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: GoogleFonts.notoSansJp(fontSize: 15, color: Colors.white70),
        hintStyle: GoogleFonts.notoSansJp(fontSize: 15, color: Colors.white38),
      ),
      navigationBarTheme: NavigationBarThemeData(
        backgroundColor: darkSurface,
        ...
        labelTextStyle: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) {
            return GoogleFonts.notoSansJp(fontSize: 12, fontWeight: FontWeight.w600, color: primaryLight);
          }
          return GoogleFonts.notoSansJp(fontSize: 12, color: Colors.white54);
        }),
      ),
